...
khachsan = [hotel('Hoa But', '5 star', 7,8,9),
hotel('Pham', '1 star', 43, 30,12),
hotel('Thong', '2 star', 52,60,23),
hotel('Hibi', '6 star', 82,22,50),
hotel('Linh', '5 star', 90,40,12),
hotel('Quang', '4 star', 44,33,22)
]
booking = list()

for phong in khachsan:
    if phong.name == 'Pham':
        phong.booking("phong don",'Hibi Vu', 8039997642, '14-02-2021', '20-2-2021')
        booking.append(phong)

khach1 = booking[0]
print(khach1.khach[0])
